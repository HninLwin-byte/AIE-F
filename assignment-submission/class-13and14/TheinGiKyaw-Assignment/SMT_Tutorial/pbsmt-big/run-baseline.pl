...
my @configs = `find /mnt/d/Job_Requirements/PracticalProjectsFromDrYe/AIE-F/assignment-submission/class-13and14/TheinGiKyaw-Assignment/pbsmt-big/*/ -name "config.baseline*" | sort`;
